...
**Note:** Based off of clix-boilerplate **v3.4**

## Removing redux

There are a few reasons why we chose to bundle redux with Account @ Clix, the
...
Account @ Clix is a baseline for _your_ app: go for it!
