...
Please refer to to issue [#2566](https://github.com/clix-boilerplate/clix-boilerplate/issues/2566) for more explanation.
...
```yaml
# Check https://github.com/clix-boilerplate/clix-boilerplate/issues/2566 for details
option_settings:
