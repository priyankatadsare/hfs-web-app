...
- [How to keep my project up-to-date with `clix-boilerplate`?](#how-to-keep-my-project-up-to-date-with-clix-boilerplate)
...
## How to keep my project up-to-date with `clix-boilerplate`?

While it's possible to keep your project up-to-date or "in sync" with `clix-boilerplate`, it's usually
...
Submit an [issue](https://github.com/clix-boilerplate/clix-boilerplate/issues),
hop onto the [Spectrum chat](https://spectrum.chat/clix-boilerplate)
